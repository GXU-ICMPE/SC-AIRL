...
class AIRL(PPON):
    ...
    def __init__(self, buffer_exp, state_shape, action_shape, device, seed,
                 gamma=0.99, rollout_length=2048, mix_buffer=1,
                 batch_size=512, lr_actor=3e-4, lr_critic=3e-4, lr_disc=1e-4,
    ...
    def update(self, writer):
        ...
        states, actions, res, dones, log_pis, next_states = self.buffer.get()
